...
export function getProviders(): Record<string, Provider> {
  ...
  return {
    github: {
      name: "GitHub",
      slug: "github",
      authorizeUrl: `${appUrl}/api-emulator/github/login/oauth/authorize`,
      tokenUrl: `${appUrl}/api-emulator/github/login/oauth/access_token`,
      userInfoUrl: `${appUrl}/api-emulator/github/user`,
      scope: "user repo",
      userNameField: "name",
    ...
    google: {
      name: "Google",
      slug: "google",
      authorizeUrl: `${appUrl}/api-emulator/google/o/oauth2/v2/auth`,
      tokenUrl: `${appUrl}/api-emulator/google/oauth2/token`,
      userInfoUrl: `${appUrl}/api-emulator/google/oauth2/v2/userinfo`,
