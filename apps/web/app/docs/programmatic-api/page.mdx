...
Use emulators as libraries in your tests and scripts. There are two approaches: the `api-emulator` CLI package (which wraps all services) and the individual `@emulators/*` scoped packages.
